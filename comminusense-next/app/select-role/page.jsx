...
/**
 * NOTE: This screen is only for MVP purposes.
 * In the full system, roles will be set up and generated automatically by the backend,
 * managed by NMDC Admin. This manual selection screen will be removed later.
 */
...
const ROLES = [
  ...
  },
  {
    id: "SUPERVISOR",
    label: "Supervisor",
    description: "Oversee team and processes",
    icon: "users",
  },
  {
    id: "PROCESS_ENGINEER",
    label: "Process Engineer",
    description: "Optimize and analyze processes",
    icon: "chart",
  },
  {
    id: "MAINTENANCE",
  ...
  },
  {
    id: "PLANT_MANAGER",
    label: "Plant Manager",
    description: "Overall plant management",
    icon: "settings",
  },
  {
    id: "NMDC_ADMIN",
...
export default function SelectRolePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-start p-4">
      {/* MVP Banner */}
      <div className="w-full max-w-5xl mb-6 p-3 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 text-center rounded shadow-sm">
        ⚠️ This role selection screen is for MVP purposes only. Roles will be
        auto-generated by NMDC Admin in the final system.
      </div>
