...
const links = [
  ...
  { href: "/machines/grinder_01", label: "Machine", icon: Factory, perm: "telemetry.read" },
  { href: "/simulation", label: "Simulation", icon: Cpu, perm: "simulation.run" },
  { href: "/maintenance", label: "Maintenance", icon: Activity, perm: "maintenance.create" },
          ...
          .map((l) => {
            ...
            return (
              <Link
                ...
                ${active ? "bg-[var(--muted)] text-foreground" : "text-muted-foreground hover:bg-[var(--muted)]/60 hover:text-foreground"}`}
              >
                <Icon size={18} />
                <span>{l.label}</span>
              </Link>
